...
<th><h5><a href="http://localhost/wp-project/booklogout.php">Log Out</a></h5></th>
</tr>
</table>
</div>
<div class="menu">
...
<strong>
      ...
      <div class="quotes">"Fairy tales are more than true
: not because they tell us that dragons exist, but because they tell us that dragons can be beaten." - Neil Gaiman, Coraline</div>
...
<div class="pay">
<h1><center>You have bought <?php echo $_SESSION['bn']; ?> for <?php echo $_SESSION['bp']; ?>!<center></h1>
</div>
<div class="about">
<table width=100%>
<col width=65%>
