...
.login
{
background:url("https://i.pinimg.com/originals/51/d6/81/51d6817f464288f5be2f5fe29c6ffb54.jpg");
color:white;
height:400px;
border:solid white;
}
...
<th width=10%><div class="dropdown"><h5>Categories</h5>
    <div class="dropdown-content">
      ...
      <a href="http://localhost/wp-project/bookyoung">Young Adult</a>
      <a href="http://localhost/wp-project/bookchild">Children</a>
      <a href="http://localhost/wp-project/booknonfi">Non Fiction</a>
    </div>
  </div> </th>
...
<div class="login">
<h2><center>INCORRECT LOGIN CREDENTIALS ! LOGIN AGAIN ! </center></h2>
<center><br>
<div class="logform">
<form name="loginf" method="post" action="http://localhost/wp-project/booklog.php" autocomplete="off">
<table>
<tr>
<th height=75px><center>Email</center></th>
<th height=75px><input type="text" name="mail" placeholder="E-mail" size="30" style="float:left"></th>
</tr>
<tr>
<th height=75px><center>Password</center></th>
<th height=75px><input type="password" name="pass" size="30" placeholder="*******" style="float:right"></th>
</tr>
<tr>

<th colspan="2" rowspan="2"><center><input type="submit" value="Log In">
</center></th>
</tr>
</table>
</form>
